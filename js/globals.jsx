...
const displace = function(amount, xory = 'x'){
    return -((amount * this.props[xory] / ( xory == 'x' ? window.innerWidth : window.innerHeight )) - amount) || 0;
}
...
let isMobile = false,
    ...
    androidUrl = "https://play.google.com/store/apps/details?id=so.ofo.abroad&hl=en",
    iosUrl = "https://itunes.apple.com/us/app/ofo-riding-your-way-in-the-us-uk-and-sg/id1190831637?mt=8";
